...
if torch.cuda.is_available():
    score_data = score.data.cpu().numpy()
else:
    score_data = score.data.numpy()

for i in range(len(class_names)):
    plt.bar(ind[i], score_data[i], width, color=color_list[i])
...
emojis_img = io.imread('images/emojis/%s.png' % str(class_names[int(pred_data)]))
