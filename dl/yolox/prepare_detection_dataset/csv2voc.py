...
#1.标签路径
csv_file = "/opt/data/SCUT-FBP5500_v2/Images/train/labels.csv"
saved_path = "./VOCFace/"                #保存路径
image_save_path = "./JPEGImages/"
image_raw_parh = "/opt/data/SCUT-FBP5500_v2/Images/train/face/"
#2.创建要求文件夹
...
annotations = pd.read_csv(csv_file,header=None).drop_duplicates().values
